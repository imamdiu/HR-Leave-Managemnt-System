...
@section('main-content')
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
        ...
        <form class="form-horizontal" action="{{ route('contactInfo.store')}}" method="POST">
          {{ csrf_field()}}
                ...
                <div class="box box-primary">
                    <div class="box-body">
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="number" name="mobile"  class="form-control" id="mobile" value="" placeholder="Mobile NO."/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="number" name="mobile2"  class="form-control" id="mobile2" value=""placeholder="Mobile No 2 (Optional)"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="email2"  class="form-control" id="email2" value=""placeholder="Alternate Email (Optional)"/>
                            </div>
                        </div>  
